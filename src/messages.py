...
from payload import UploadBasePayload, RequestBasePayload
...
async def run_service(
    service_name: str, 
    channel_name: str, 
    payload_class: Type[UploadBasePayload], 
    callback: Callable[[UploadBasePayload], Awaitable[None]]
):
    """
...
async def run_service_req(
    service_name: str, 
    channel_name: str, 
    payload_class: Type[RequestBasePayload], 
    callback: Callable[[RequestBasePayload], Awaitable[None]]
):
    """
    A generic listener for any service.
    :param service_name: Name for logging (e.g., "ImageService")
...
async def publish_message(channel_name: str, payload: RequestBasePayload):
    """
